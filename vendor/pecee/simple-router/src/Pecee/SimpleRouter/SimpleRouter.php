...
class SimpleRouter
{
     ...
     * @var string
     */
    protected static $defaultNamespace = 'IqFramework\Controllers';
     ...
     */
    public static function setDefaultNamespace($setDefaultNamespace)
    {
        static::$defaultNamespace = $setDefaultNamespace;
    }
